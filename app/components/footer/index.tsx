    ...
    <footer className="footer">
      <div className="content-container">
        <a className="focus-outline" href="#">
          <img className="footer__logo" src="./images/logo.svg" alt="Home" />
        </a>
        ...
        <nav aria-label="Footer navigation">
          ...
          <div className="footer__social-links">
            <a href="#">
              ...
              >
                <title id="facebook-icon">Open Facebook link</title>
            ...
            <a href="#">
              ...
              >
                <title id="twitter-icon">Open Twitter link</title>
                {/* Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. */}
            ...
            <a href="#">
              ...
              >
                <title id="instagram-icon">Open Instagram link</title>
                {/* Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. */}
